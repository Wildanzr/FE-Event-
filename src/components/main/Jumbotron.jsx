...
const Jumbotron = () => {
    return (
        <>
        <div className="flex flex-col-reverse py-8 items-center bg-[#F2F5FA] text-center lg:py-20 lg:flex-row lg:text-justify">
            <div className="w-11/12 mx-auto my-auto text-[#003366] lg:mx-24">
                ...
                <button
                    className="bg-[#003366] font-nunito text-white items-center py-2 px-8 rounded-lg text-base focus:outline-none mt-5 lg:mt-0">
                    Get Started
                </button>
            </div>
