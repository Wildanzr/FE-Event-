...
const Stats = () => {
  return (
    <div className="flex flex-col items-center justify-center pb-20 bg-[#F2F5FA] text-[#003366] lg:flex-row">
      <div className="flex flex-col rounded-xl items-center justify-center bg-white drop-shadow-md w-72 h-48 py-2 px-2 mx-10 my-5 lg:my-20">
