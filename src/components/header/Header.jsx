        ...
        <section className="h-full w-full border-box transition-all duration-500 linear lg:px-24 md:px-20 px-3 py-3 bg-[#F2F5FA]">
            <div className="navbar-1-1">
                <div className="container mx-auto flex flex-wrap flex-row items-center justify-between md:px-0 md:py-1">
                    ...
                    id="menu">
                    <nav
                        className="items-center justify-center text-base text-[#5C7B99] pt-4 space-x-0 space-y-4 lg:space-x-20 lg:flex lg:pt-0 lg:space-y-0">
                        <a href="" className="text-center font-semibold block nav-link hover:font-bold hover:text-[#003366]">Home</a>
                        <a href="" className="text-center font-semibold block nav-link hover:font-bold hover:text-[#003366]">Event</a>
                        <a href="" className="text-center font-semibold block nav-link hover:font-bold hover:text-[#003366]">Company</a>
                        <a href="" className="text-center font-semibold block nav-link hover:font-bold hover:text-[#003366]">Contacts</a>
                    </nav>
                    </div>
